...
public class PrefUtils {
    ...
    private static final String PREF_NAME = SdkApp.getInstance().getPackageName();
    ...
    public static PrefUtils getInstance() {
        ...
        pref = SdkApp.getInstance().getSharedPreferences(PREF_NAME, PRIVATE_MODE);
        editor = pref.edit();
        editor.apply();
        if (prefUtils == null) {
    ...
    protected String encrypt(String value) {
        ...
        try {
            ...
            pbeCipher.init(Cipher.ENCRYPT_MODE, key, new PBEParameterSpec(UTF8.getBytes(Settings.Secure.getString(SdkApp.getInstance().getContentResolver(), Settings.Secure.ANDROID_ID)), 20));
    ...
    protected String decrypt(String value) {
        try {
            ...
            SecretKey key = keyFactory.generateSecret(new PBEKeySpec(SEKRIT));
            Cipher pbeCipher = Cipher.getInstance("PBEWithMD5AndDES");
            pbeCipher.init(Cipher.DECRYPT_MODE, key, new PBEParameterSpec(Settings.Secure.getString(SdkApp.getInstance().getContentResolver(), Settings.Secure.ANDROID_ID).getBytes(StandardCharsets.UTF_8), 20));

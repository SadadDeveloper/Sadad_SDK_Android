...
import cards.sadadsdk.listener.TransactionCallBack;
import cards.sadadsdk.model.SadadOrder;
import cards.sadadsdk.paymentselection.SadadService;
import cards.sdkdemo.api.ApiList;
import cards.sdkdemo.api.DataObserver;
import cards.sdkdemo.api.RequestCode;
import cards.sdkdemo.api.RequestMethod;
import cards.sdkdemo.api.RestClient;
import cards.sdkdemo.api.ServerConfig;
import cards.sdkdemo.base.BaseActivity;
import cards.sdkdemo.base.Constant;
import cards.sdkdemo.transactionstatus.TransactionStatusActivity;
import cards.sdkdemo.utils.ButtonRobotoRegular;
import cards.sdkdemo.utils.TextViewRobotoBold;
import cards.sdkdemo.utils.TextViewRobotoRegular;
import cards.sdkdemo.utils.Utils;
...
//            }
    ...
    public void onTransactionFailed(String errorJson) {
        ...
        if (jsonObject != null && jsonObject.has("statusCode") && jsonObject.optInt("statusCode") == 402) {
            showSnackBar(rootView, jsonObject.optString("message"), "Ok", false, null);
        } else {
            Intent intent = new Intent(HomeActivity.this, TransactionStatusActivity.class);

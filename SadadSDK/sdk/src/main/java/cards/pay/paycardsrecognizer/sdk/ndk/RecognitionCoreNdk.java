...
final class RecognitionCoreNdk implements RecognitionCoreImpl {
    ...
    public synchronized void setRecognitionMode(@RecognitionConstants.RecognitionMode int mode) {
    ...
    native void nativeSetRecognitionMode(@RecognitionConstants.RecognitionMode int recognitionMode);

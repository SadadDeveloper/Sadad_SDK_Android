...
import cards.sadadsdk.adapters.ExpirationDateItemAdapter;
import cards.sadadsdk.utils.DateValidator;
import cards.sadadsdk.utils.SlashSpan;
...
public class ExpirationDateDialog extends Dialog implements DialogInterface.OnShowListener {
    ...
    public static ExpirationDateDialog create(AppCompatActivity activity, ExpirationDateEditText editText) {
...
//        addDateSlash(mEditText.getEditableText());

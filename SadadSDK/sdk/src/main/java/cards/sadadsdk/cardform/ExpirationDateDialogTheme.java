...
import cards.sadadsdk.utils.ColorUtils;
import cards.sadadsdk.utils.ViewUtils;
...
public enum ExpirationDateDialogTheme {
    ...
    public static ExpirationDateDialogTheme detectTheme(AppCompatActivity activity) {

...
//    private View.OnClickListener onClickEvent;
    ...
    private void failedResult(String errorMsg) {
...
//                pushFragment(SadadFragment.newInstance(PaymentSelectionActivity.this), true, false, getIntent().getBundleExtra(Constant.SDK_DATA));
                ...
                case Constant.SDK_RESULT_CODE:
                    ...
                    if (intent != null) {
                        ...
                        if (TextUtils.isEmpty(data)) {
                            failedResult(getString(R.string.str_transaction_failed));
                        } else {
    ...
    public void onCheckSumReceived(String checkSum) {
        ...
        if (TextUtils.isEmpty(checkSum)) {
            failedResult(getString(R.string.str_invalid_checksum));
        } else {
            try {
    ...
    @Override
    public void onCheckSumFailed(String errorMsg) {
        failedResult(getString(R.string.str_invalid_checksum));
    }
